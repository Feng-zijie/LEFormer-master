...
if __name__ == '__main__':
    input_tensor = torch.randn(16, 32, 64, 64)  # 输入张量，形状为 [batch_size, channels, height, width]
    model = MLLA(img_size=(64,64),in_chans=32)  # 实例化 MDFA 模块
    output_tensor = model(input_tensor)  # 前向传播
    print("MDFA output shape:", output_tensor.shape)  # 打印输出张量的形状